...
class Leaf {
  ...
  static Leaf getLeafById(int leafId) {
    ...
    final sql =
        'SELECT TreeID, ValueType, IntValue, FloatValue, StringValue, MushroomValue, SpellValue, BinaryValue FROM $tableName WHERE LeafID = ?';
    ...
    if (result.isNotEmpty) {
      ...
      stmt.dispose();
      return Leaf(
          tree: ftree!, valueType: fvalueType, value: fvalue, id: leafId);
    } else {
